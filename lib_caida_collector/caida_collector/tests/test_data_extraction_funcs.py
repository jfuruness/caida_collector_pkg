...
from ...links import CustomerProviderLink as CPLink, PeerLink


@pytest.mark.data_extraction_funcs
class TestDataExtractionFuncs:
    def test_get_ases(self, mock_caida_collector, decoded_path):
        ...
        (cp_links,
         peer_links,
         ixps,
         input_clique) = mock_caida_collector._get_ases(lines)
        ...
        ground_truth_ixps = set([1200, 4635, 5507, 6695, 7606, 8714,
                                         9355, 9439, 9560, 9722, 9989, 11670,
                                         15645, 17819, 18398, 21371, 24029,
                                         24115, 24990, 35054, 40633, 42476,
                                         43100, 47886, 48850, 50384, 55818,
                                         57463])
 
        ground_truth_input_clique = set([174, 209, 286, 701, 1239, 1299, 2828, 2914,
    ...
    def test_extract_input_clique(self, mock_caida_collector):
        """Tests input_clique is decoded correctly"""

        line = ("# input clique: 174 209 286 701 1239 1299 2828 "
    ...
    def test_extract_ixp_ases(self, mock_caida_collector):
        """Tests ixps are decoded correctly"""

        line = ("# IXP ASes: 1200 4635 5507 6695 7606 8714 9355 9439 "
    ...
    def test_extract_provider_customers(self, mock_caida_collector):
    ...
    def test_extract_peers(self, mock_caida_collector):
