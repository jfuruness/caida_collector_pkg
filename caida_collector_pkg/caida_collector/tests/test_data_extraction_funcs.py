...
class TestDataExtractionFuncs:
    def test_get_ases(self,
        ...
        ground_truth_cp_links = set([CPLink(provider_asn=1,
                                     ...
                                     CPLink(provider_asn=1,
                                            customer_asn=61396),
                                     CPLink(provider_asn=2,
                                            customer_asn=55855),
                                     CPLink(provider_asn=4,
                                            customer_asn=7633),
                                     CPLink(provider_asn=5,
                                            customer_asn=21710),
                                     CPLink(provider_asn=6,
                                            customer_asn=64031),
                                     CPLink(provider_asn=10,
                                            customer_asn=131401)])
    ...
    def test_extract_provider_customers(self,
                                        mock_caida_collector: CaidaCollector):
